...
<body class="bg-light">
	...
	<div class="container">
		...
		<form name="editItem" action="/fleaMarket/processEditFlea.jsp?id=<%=id %>" class="form-horizontal" method="post" enctype="multipart/form-data">
			
			<div class="form-group row">
				<label class="col-sm-2"><fmt:message key="name"/></label>
				<div class="col-sm-3">
					<input type="text" id="name" name="name" value="<%=flea.getName() %>" class="form-control" maxlength="30">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="unitPrice" name="unitPrice" value="<%=flea.getUnitPrice() %>" class="form-control" maxlength="10">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<textarea id="description" name="description" cols="50" rows="2" class="form-control"><%=flea.getDescription() %></textarea>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="category" name="category" value="<%=flea.getCategory() %>" class="form-control" maxlength="20">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="unitsInStock" name="unitsInStock" value="<%=flea.getUnitsOfStock() %>" class="form-control" maxlength="11">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<img src="/resources/images/<%=flea.getFileName()%>" style="width: 100%" class="img-thumbnail">
				</div>
			</div>
